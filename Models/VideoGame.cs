...
namespace VideoGameRepository.Classes
{
    internal class VideoGame
    {
        ...
        public VideoGame(string title, string category, int year, int playerCount, float price, Studio studio, HashSet<VideoGameConsole> consoles, Publisher publisher, int ageRating, string wikiLink)
        {
            Title = title;
            Category = category;
            Year = year;
